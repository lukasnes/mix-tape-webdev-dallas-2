...
const PlaylistRow = ({ pl, setPlaylist, user, isFollowing, hasLiked, allPlaylist }) => {
  ...
  return isLoggedIn ? (
    <div id="playlistRow" className="displayRow">
      ...
      <div id="deleteButtonDiv">
        ...
        <DelOrLike pl={pl} setPlaylist={setPlaylist} liked={hasLiked} setLikesCount={setLikesCount} likesCount={likesCount} allPlaylist={allPlaylist} />
      </div>
    </div>
  ) : (
    <div id="playlistRow" className="displayRow">
