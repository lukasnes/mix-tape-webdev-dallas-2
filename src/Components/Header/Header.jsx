  ...
  const handleFreindsList = () => {
    ...
    return isLoggedIn ? (
      <div id='tapeMain' className="tape">
        ...
        <div id='window'>
          <button className="button roundButton" id='topButton' onClick={handleTopPlaylist}> <BsFire/> </button>
          <button className="button" id='logoutButton' onClick={handleLogout}> Logout </button>
          <button className="button roundButton" id='friendsButton' onClick={handleFreindsList} > <BsHeartFill/> </button>
        </div>
        <div id='tapeBottom' className="">
          <div id='signUpDiv' className="tape">
            <button className="button" onClick={handleMyPlaylist}> My Playlists</button>
          </div>
        </div>
      </div>  
    ):
    (
      ...
      <div id='tapeMain' className="tape">
        ...
        <div id='window'>
            <button className="button roundButton" id='topButton' onClick={handleTopPlaylist}> <BsFire/> </button>
            <button className="button" id='loginButton' onClick={handleLoginOpen} > Login </button>
            <button className="button roundButton" id='friendsButton' disabled={true}> <BsHeart/> </button>
          </div>
          <div id='tapeBottom' className="">
            <div id='signUpDiv' className="tape">
